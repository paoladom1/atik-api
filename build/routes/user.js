...
module.exports = function (app) {
  ...
  app.get("/api/users/:userId", _passport2.default.authenticate("jwt", {
    session: false
  }), (0, _routesHelper.allowOnly)(_config2.default.accessLevels.client, _user.findById));

  // update a user with id
  app.put("/api/users/:userId", _passport2.default.authenticate("jwt", {
    session: false
  }), (0, _routesHelper.allowOnly)(_config2.default.accessLevels.client, _user.update));
