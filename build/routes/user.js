...
module.exports = function (app) {
  // create a new user
  app.post('/api/users/create', _user.create);

  // user login
  app.post('/api/users/login', _user.login);

  // get current user
  app.get('/api/users/me', _passport2.default.authenticate('jwt', { session: false }), _user.me);
  ...
  app.put('/api/users/:userId', _passport2.default.authenticate('jwt', {
    session: false
  }), (0, _routesHelper.allowOnly)(_config2.default.accessLevels.admin, _user.update));
